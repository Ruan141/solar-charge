      ...
      <ScrollView contentContainerStyle={styles.scrollContentContainer}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.bulletPoint}>
            • <Text style={styles.stat}>93%</Text> of new car sales are electric (May 2025)
          </Text>
          <Text style={styles.bulletPoint}>• 1 in 4 cars on the road are electric</Text>
          <Text style={styles.bulletPoint}>
            • 98% of electricity is renewable, reducing EV emissions
          </Text>
        </View>
        ...
        <View style={styles.highlightBox}>
          ...
          <Text style={styles.bulletPoint}>
            • Gasoline car: <Text style={styles.stat}>49,559 kg</Text>
          </Text>
          <Text style={styles.bulletPoint}>
            • Diesel car: <Text style={styles.stat}>38,504 kg</Text>
          </Text>
          <Text style={styles.bulletPoint}>
            • EV (conventional electricity): <Text style={styles.stat}>17,497 kg</Text>
          </Text>
          <Text style={styles.bulletPoint}>
            • EV (renewable electricity): <Text style={styles.stat}>5,492 kg</Text>
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.bulletPoint}>
            • <Text style={styles.stat}>81%</Text> of charging is done at home, mostly overnight
          </Text>
          <Text style={styles.bulletPoint}>
            • Fast charging is viewed as a rest opportunity by <Text style={styles.stat}>65%</Text>{' '}
            of drivers
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.bulletPoint}>
            • <Text style={styles.bold}>Battery Life:</Text> EV batteries outlast vehicles despite
            minor degradation
          </Text>
          <Text style={styles.bulletPoint}>
            • <Text style={styles.bold}>Fire Safety:</Text> EVs are{' '}
            <Text style={styles.stat}>less likely</Text> to catch fire than ICE vehicles
          </Text>
          <Text style={styles.bulletPoint}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.bulletPoint}>
            • <Text style={styles.stat}>92%</Text> of Norwegian EV drivers are satisfied or very
            satisfied
          </Text>
        </View>
